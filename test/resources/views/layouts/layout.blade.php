...
<head>
    ...
    <meta name="description" content="practice laravel">
    <meta name="author" content="Rex Louis Roncesvalles">
    <!-- Favicon icon -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="{{ asset('../assets/images/users/1.jpg') }}" alt="user" /> 
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">@yield('page')</h3>
                </div>
